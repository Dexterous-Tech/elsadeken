...
class _SignupSocialStatusState extends State<SignupSocialStatus> {
                ...
                children: [
                  ...
                  SignupMultiChoice(
                    ...
                    selected: maritalStatusOptions(
                        context)[cubit.maritalStatusController.text],
                    onChanged: (newStatus) async {
                      // Find the key for the selected text
                      String? selectedKey = maritalStatusOptions(context)
                          .entries
                      ...
                      if (selectedKey.isNotEmpty) {
                        ...
                        // Save isSingle status to shared preferences
                        bool isSingle = selectedKey.toLowerCase() == 'single';
                        await SharedPreferencesHelper.setIsSingle(isSingle);
                  ...
                  SignupMultiChoice(
                    ...
                    selected: typeOfMarriageOptions(
                        context)[cubit.typeOfMarriageController.text],
                    onChanged: (newType) {
                      // Find the key for the selected text
                      String? selectedKey = typeOfMarriageOptions(context)
                          .entries
  ...
  bool _canProceedToNext(SignupCubit cubit) {
    ...
    bool hasMaritalStatus = cubit.maritalStatusController.text.isNotEmpty &&
        maritalStatusOptions(context)
            .containsKey(cubit.maritalStatusController.text);
    ...
    bool hasTypeOfMarriage = cubit.typeOfMarriageController.text.isNotEmpty &&
        typeOfMarriageOptions(context)
            .containsKey(cubit.typeOfMarriageController.text);
